...
namespace FinalProject.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,MemberId,BookId,Rating,Comment,ReviewDate,DateUpdated")] Review review)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Books, "BookId", "Isbn", review.BookId);
            ViewData["MemberId"] = new SelectList(_context.Members, "MemberId", "Email", review.MemberId);
            return View(review);
        }
